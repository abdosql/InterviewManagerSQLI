 ...
 */
final class Version20240828142922 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE interview_status ADD interview_id INT DEFAULT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_1BF9696B55D69D95 ON interview_status (interview_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE interview ADD CONSTRAINT FK_CF1D3C34529D7BBC FOREIGN KEY (interview_status_id) REFERENCES interview_status (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        ...
        $this->addSql('DROP INDEX IDX_1BF9696B55D69D95 ON interview_status');
